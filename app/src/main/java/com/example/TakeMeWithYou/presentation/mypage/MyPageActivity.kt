package com.example.TakeMeWithYou.presentation.mypage
...
import com.example.TakeMeWithYou.Postpageadd
...
class MyPageActivity : AppCompatActivity() {
    ...
    private fun initLisView() {
        ...
        for (i in listViewItem) {
            ...
            val itemViewImageView: ImageView = itemView.findViewById(R.id.s_post_img)
            val itemViewIdView: TextView = itemView.findViewById(R.id.s_post_auth)
            val itemViewLikeCount: TextView =
                itemView.findViewById(R.id.s_post_like_count)
            val itemViewLikeButton: ImageButton = itemView.findViewById(R.id.s_post_btn_like)
